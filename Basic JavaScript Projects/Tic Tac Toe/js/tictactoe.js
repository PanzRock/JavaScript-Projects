//This variable keeps track of whose turm it is.
let activePlayer = 'X';
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            //Active player may only be 'X' or 'O' so, if not 'X' it must be 'O'   
                ...
                //if activePlayer is equal to 'O', then o.png is placed in HTML
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        //this method clears content for the last loop iteration
        ...
        //this ocndition is similar to the one above
        //this is necessary for the 6, 4, 2 win condition
        if (x1 <= x2 && y1 <= y2) {
            if (x < x2) { x += 10; }
            if (y > y2) { y -= 10; }
    ...
    animateLineDrawing();
    //this line waits 1 second. then clear canvas, reset game, and allows clicking again
